class ClientHandler
!!!128898.java!!!	ClientHandler(inout clientSocket : Socket, inout clientThreads : Map<Socket, ClientHandler>, inout salons : List<Salon>, inout salonActuel : Salon)
...
!!!129154.java!!!	getUserName() : String
    return this.username;
!!!129282.java!!!	sendMessage(in userName : String, in message : String) : void
    try {
...
!!!129410.java!!!	sendCommandMessage(in message : String) : void
    try {
      out.write(message);
      out.newLine();
      out.flush();
...
!!!129538.java!!!	getCommand(in message : String) : void
...
!!!129666.java!!!	estSalon(in nomS : String) : boolean
    Boolean res = false;
    for (Salon s : this.salons) {
      if (s.getNom().equals(nomS)) {
        return true;
    ...
    return res;
!!!129794.java!!!	sendPrivateMessage(in userName : String, in message : String) : void
...
!!!129922.java!!!	addUsername() : String
    ...
    return name;
!!!130050.java!!!	verificationName(in name : String) : boolean
